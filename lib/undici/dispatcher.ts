// based on https://github.com/nodejs/undici/blob/ded60f65772371b52d575e602a82551905bbeda8/types/dispatcher.d.ts (MIT)
...
export type IncomingHttpHeaders = { [key: string]: string | string[] | undefined }
...
declare class Dispatcher extends EventEmitter {
    ...
    on(
        ...
        callback: (origin: URL, targets: readonly Dispatcher[], error: Error) => void,
    ): this
    on(
    ...
    listeners(
        eventName: 'disconnect',
    ): ((origin: URL, targets: readonly Dispatcher[], error: Error) => void)[]
    listeners(
        eventName: 'connectionError',
    ): ((origin: URL, targets: readonly Dispatcher[], error: Error) => void)[]
...
declare namespace Dispatcher {
    ...
    export type PipelineHandlerData = {
        statusCode: number
        headers: IncomingHttpHeaders
        opaque: unknown
        body: BodyReadable
    ...
    export type DispatchInterceptor = (dispatch: Dispatcher['dispatch']) => Dispatcher['dispatch']
}
